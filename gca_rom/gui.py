...
def hyperparameters_selection(name, var, n, root=tk.Tk()):
    ...
    preset_options_1 = ["sample", "feature", "feature-sampling", "sampling-feature"]  # Preset options for the dropdown menu
    ...
    preset_options_2 = ["minmax", "robust", "standard"]  # Preset options for the dropdown menu
    ...
    preset_options_3 = ["10", "20", "30", "40", "50"]  # Preset options for the dropdown menu
    ...
    preset_options_4 = ["50", "100", "200", "300", "400"]  # Preset options for the dropdown menu
    ...
    preset_options_5 = ["25", "50", "75", "100", "125"]  # Preset options for the dropdown menu
    ...
    preset_options_6 = ["10", "15", "20", "25", "30"]  # Preset options for the dropdown menu
    ...
    preset_options_7 = ["0.01", "0.1", "1", "10", "100"]  # Preset options for the dropdown menu
    ...
    preset_options_8 = ["1", "2", "3", "4", "5"]  # Preset options for the dropdown menu
